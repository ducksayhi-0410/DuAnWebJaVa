...
<html lang="vi">
    ...
    <body>
        ...
        <%
            ...
            // Xóa ngay để không hiển thị lại
            if (cartSuccess != null) {
        ...
        <main class="container">
            ...
            <% if (cartSuccess != null) { %>
                <div class="cart-notification success">
                    <%= cartSuccess %>
                </div>
            <% } %>
            <% if (cartError != null) { %>
                <div class="cart-notification error">
                    <%= cartError %>
                </div>
            <% } %>
                    ...
                    <div class="product-grid">
                        ...
                        <div class="product-card" data-price="<%= p.getPrice()%>">
                            ...
                            <div class="product-info">
                                ...
                                <p 
 class="product-quantity">Số lượng còn lại: <%= p.getQuantity() %></p>
